...
You need to use `git add` to add files to the repository.  You can then use `git commit` to commit the changes to your repository, and `git push` to update the central repository (the one on `github.umn.edu`)
